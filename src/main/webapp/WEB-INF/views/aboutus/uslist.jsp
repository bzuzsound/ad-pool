	...
	<div class="wrapper" style="margin-top: 30px;">
		...
		<div class="tapmenu centered">
			<table class="table table-hover table-bordered"
				...
				<c:forEach var="usList" items="${usList}" varStatus="i">
				<tr>
					<td style="width: 100px;"><img alt="" src="${usList.u_pic}"></td>
					<td><h3>
							${usList.u_name}
							<p>
						</h3></td>
					<td><h3>${usList.u_role}</h3></td>
					<td><h3>${usList.u_email}</h3></td>
					<td><h3>${usList.u_birth}</h3></td>
				</tr>
				</c:forEach>
				<%-- <tr>
			...
			<div>
				<a type="button" class="btn btn-primary" href="usregister">등록하기</a>
			</div>
		</div>
	</div>
	<!-- 푸터 삽입 시작 -->
